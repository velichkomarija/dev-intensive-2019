...
/**
 * Класс, описывающий активность архивных чатов.
 */
class ArchiveActivity : AppCompatActivity() {
    ...
    /**
     * Стандартный метод ЖЦ по созданию активности.
     */
    ...
    private fun initViews() {
        ...
        // создание обработчика жестов для элемента архива
        ...
        // регистрация обработчика смахиваний элемента
        val touchHelper = ItemTouchHelper(touchCallBack)
        touchHelper.attachToRecyclerView(rv_archive_list)

        // применение адаптера для чата
    ...
    /**
     * Создание элемента контекстного меню для реализации поиска.
     */
    ...
    /**
     * Реализациия метода-обработчика выбора элемента контекстного меню.
     */
